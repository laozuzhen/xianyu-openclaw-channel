...
class XianyuLive:
    ...
    async def main(self):
        ...
        try:
                ...
                try:
                    ...
                    async with await self._create_websocket_connection(headers) as websocket:
                        ...
                        try:
                            ...
                            # 🔗 OpenClaw Bridge: 注册 XianyuLive 实例
                            if BRIDGE_ENABLED:
                                register_xianyu_instance(self.cookie_id, self)
                                logger.info(f"【{self.cookie_id}】已注册到 OpenClaw Bridge")
            ...
            # 🔗 OpenClaw Bridge: 注销 XianyuLive 实例
            if BRIDGE_ENABLED:
                unregister_xianyu_instance(self.cookie_id)
                logger.info(f"【{self.cookie_id}】已从 OpenClaw Bridge 注销")
